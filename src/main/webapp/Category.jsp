...
<div class="mb-5 p-4 rounded-lg bg-green-100 border border-green-400 text-green-700">
...
<div class="mb-5 p-4 rounded-lg bg-red-100 border border-red-400 text-red-700">
...
<td colspan="3" class="py-6 text-center text-red-600">
