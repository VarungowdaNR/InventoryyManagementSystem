...
<div class="mb-5 bg-green-100 border border-green-400 text-green-700 px-5 py-3 rounded-lg">
...
<div class="mb-5 bg-red-100 border border-red-400 text-red-700 px-5 py-3 rounded-lg">
...
<button
type="reset"
class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg ml-3">
